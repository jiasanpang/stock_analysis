...
export const ReportDetails: React.FC<ReportDetailsProps> = ({
  ...
  return (
    <Card variant="bordered" padding="md" className="text-left">
      ...
      {/* Record ID */}
      {recordId && (
        <div className="flex items-center gap-2 text-xs text-muted mb-3 pb-3 border-b border-border">
          <span>Record ID:</span>
        ...
        {details?.rawResult && (
          <div>
            <button
              ...
              className="w-full flex items-center justify-between p-2.5 rounded-lg bg-elevated hover:bg-surface-hover transition-colors"
            >
