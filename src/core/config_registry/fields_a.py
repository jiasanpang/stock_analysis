...
_FIELD_DEFS_A: Dict[str, Dict[str, Any]] = {
    ...
    "MINIMAX_API_KEYS": {
        ...
        "description": "MiniMax API key (search priority: Bocha > Tavily > Brave > SerpAPI > Zhipu > MiniMax > SearXNG).",
        "description_zh": "MiniMax 新闻检索密钥；检索优先级：Bocha > Tavily > Brave > SerpAPI > Zhipu > MiniMax > SearXNG。",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ZHIPU_API_KEYS": {
        "title": "Zhipu API Keys",
        "title_zh": "智谱 API Keys",
        "description": "Zhipu BigModel API keys for Web Search API (shares key with GLM chat). Comma-separated.",
        "description_zh": "智谱 BigModel API 密钥（Web Search API，与 GLM 对话共用同一 key），逗号分隔多个。",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
